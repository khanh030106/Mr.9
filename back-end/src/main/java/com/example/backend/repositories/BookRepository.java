...
""")
    ...
    // --- ALL BOOKS FILTER REFACTOR START: support combined filters (price/category/author) ---
    @Query("""
        SELECT
            b.id AS id,
            b.title AS title,
    ...
    // --- ALL BOOKS FILTER REFACTOR END: support combined filters (price/category/author) ---
